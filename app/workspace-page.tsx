    ...
    operations: {
      type: "array", maxItems: 16, items: {
        ...
        properties: {
          ...
          target: { type: "string", maxLength: 128 }, title: { type: "string", maxLength: 100 }, markup: { type: "string", maxLength: MAX_HTML_LENGTH, description: "Presentation-only HTML for a widget. Do not include Markdown links, anchor elements, href attributes, linked URLs, or button-like links. Express any next step as plain text." },
